...
1. **automation_pipeline.py** (1300+ lines)
   - Main orchestrator
   - Scheduler & timing
   - Component coordination

2. **control_center.py** (600+ lines)
   - REST API server
...
### API (Programmatic)
```
http://192.168.1.100:5000/api/v1/status
Port: 5000
...
### Device Control
```
TCP Connection to 192.168.1.100:5001
